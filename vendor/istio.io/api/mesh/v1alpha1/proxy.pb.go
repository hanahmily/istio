...
type ProxyConfig struct {
	...
	// Address of the Envoy gRPC Access Log Service (ALS) implementation.
	...
	EnvoyAlsAddress      string   `protobuf:"bytes,22,opt,name=envoy_als_address,json=envoyAlsAddress,proto3" json:"envoy_als_address,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ProxyConfig) GetEnvoyAlsAddress() string {
	if m != nil {
		return m.EnvoyAlsAddress
	}
	return ""
}
...
var fileDescriptor_5efecd978cf3d28d = []byte{
	...
	,
}
...
func (m *ProxyConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.EnvoyAlsAddress) > 0 {
		dAtA[i] = 0xb2
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintProxy(dAtA, i, uint64(len(m.EnvoyAlsAddress)))
		i += copy(dAtA[i:], m.EnvoyAlsAddress)
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *ProxyConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 22:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnvoyAlsAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnvoyAlsAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProxy(dAtA[iNdEx:])
